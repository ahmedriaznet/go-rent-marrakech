      ...
      <main className="flex min-h-screen flex-col overflow-x-hidden">
        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none">
            {/* Top Left Corner */}
            <svg
              className="absolute top-0 left-0 w-32 h-32 text-white/20"
              viewBox="0 0 100 100"
              fill="none"
            >
              <path
                d="M0,0 L40,0 C30,10 20,20 10,30 C20,20 30,10 40,0 L0,40 Z"
                fill="currentColor"
              />
              <path
                d="M50,0 L90,0 C80,10 70,20 60,30 C70,20 80,10 90,0 L50,40 Z"
                fill="currentColor"
              />
            </svg>
            ...
            {/* Top Right Corner */}
            <svg
              className="absolute top-0 right-0 w-32 h-32 text-white/20"
              viewBox="0 0 100 100"
              fill="none"
            >
              <path
                d="M100,0 L60,0 C70,10 80,20 90,30 C80,20 70,10 60,0 L100,40 Z"
                fill="currentColor"
              />
              <path
                d="M50,0 L10,0 C20,10 30,20 40,30 C30,20 20,10 10,0 L50,40 Z"
                fill="currentColor"
              />
            </svg>
            ...
            {/* Bottom Left Corner */}
            <svg
              className="absolute bottom-0 left-0 w-32 h-32 text-white/20"
              viewBox="0 0 100 100"
              fill="none"
            >
              <path
                d="M0,100 L40,100 C30,90 20,80 10,70 C20,80 30,90 40,100 L0,60 Z"
                fill="currentColor"
              />
              <path
                d="M50,100 L90,100 C80,90 70,80 60,70 C70,80 80,90 90,100 L50,60 Z"
                fill="currentColor"
              />
            </svg>
            ...
            {/* Bottom Right Corner */}
            <svg
              className="absolute bottom-0 right-0 w-32 h-32 text-white/20"
              viewBox="0 0 100 100"
              fill="none"
            >
              <path
                d="M100,100 L60,100 C70,90 80,80 90,70 C80,80 70,90 60,100 L100,60 Z"
                fill="currentColor"
              />
              <path
                d="M50,100 L10,100 C20,90 30,80 40,70 C30,80 20,90 10,100 L50,60 Z"
                fill="currentColor"
              />
            </svg>
          </div>
          ...
          <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center items-center text-center text-white pt-44 md:pt-40 lg:pt-28 pb-32 md:pb-28 lg:pb-20">
            ...
            >
              ...
              >
                {language === "en"
                  ? "Premium Car Rental in Marrakech"
                  : "Location de Voitures Premium à Marrakech"}
              </motion.h1>
              <motion.p
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-sm font-medium">
                      {t("quickInfo.freeCancel")}
                    </p>
                    <p className="text-xs text-gray-500">
                      {t("quickInfo.freeCancel24h")}
                    </p>
                  </div>
                </div>
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-sm font-medium">
                      {t("quickInfo.support247")}
                    </p>
                    <p className="text-xs text-gray-500">
                      {t("quickInfo.permanentAssist")}
                    </p>
                  </div>
                </div>
                <div className="flex items-center">
        ...
        >
          ...
          <div className="container mx-auto px-4">
            <motion.div className="text-center mb-12" variants={fadeInUp}>
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Discover our latest articles, tips and offers for your car
                rental in Marrakech
              </p>
            </motion.div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className="p-8">
                      ...
                      <p className="text-gray-600 mb-6">
                        {t(
                          "blog.posts.professional-reliable-car-rental.excerpt",
                        )}
                      </p>
              ...
              >
                <div className="bg-white rounded-2xl shadow-xl p-8 w-full">
                  ...
                  <h3 className="text-xl font-bold text-center mb-4">
                    {t("faq.needMoreHelp.title")}
                  </h3>
                  <p className="text-gray-600 text-center mb-6">
                    {t("faq.needMoreHelp.description")}
                  </p>
                  <Link href="/contact">
